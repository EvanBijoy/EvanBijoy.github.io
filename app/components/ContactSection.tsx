					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<div className="flex items-center gap-2 text-gray-300">
								...
								<span>IIIT Hyderabad, Telangana</span>
							</div>
							<p className="text-green-500 mt-8 mb-2">$ contact --email</p>
							<motion.a
								href="mailto:evanbijoy13@gmail.com"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/EvanBijoy"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@EvanBijoy</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/evan-bijoy-5446021b9/"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">Evan Bijoy</p>
									</div>
								</motion.a>
								<motion.a
									href="https://x.com/Evan01904377"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">@Evan01904377</p>
									</div>
								</motion.a>
							</div>
						</div>
